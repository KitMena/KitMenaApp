<script>
    ...
    onMount(async () => {
        ...
        // Add markers for Croix Rouge locations
        const croixRougeLocations = locationsData["Croix rouge"];
        croixRougeLocations.forEach((location) => {
