    ...
    <main class="box_map">
        <div class="card">
            ...
            <div class="container" style="margin-top: 4vh;">
                <div class="row">
                    <h3
                        style="font-weight: bold; margin-bottom: 4vh; margin-top: 6vh;"
                    >
                        Lieux utiles
                    </h3>
                    <div class="col">
                        <p>
                            Je signale mon arrivée en Belgique<br />
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="20"
                                height="20"
                    ...
                    <div class="col">
                        <p>
                            J'ai besoin d'aide administrative
                            <br />
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="16"
