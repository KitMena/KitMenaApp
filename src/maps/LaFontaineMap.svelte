<script>
    ...
    onMount(async () => {
        ...
        // Add markers for La Fontaine locations
        const laFontaineLocations = locationsData["La Fontaine"];
        laFontaineLocations.forEach((location) => {
