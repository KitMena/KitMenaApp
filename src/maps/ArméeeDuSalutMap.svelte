<script>
    ...
    onMount(async () => {
        ...
        // Add markers for Armée du Salut locations
        const armySalvationLocations = locationsData["Armée du Salut"];
        armySalvationLocations.forEach((location) => {
