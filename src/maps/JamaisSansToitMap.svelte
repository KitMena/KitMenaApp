<script>
    ...
    onMount(async () => {
        console.log("map : JamaisSansToit");
        // Initialize the map
        ...
        // Add markers for Jamais sans toit locations
        const jamaisSansToitLocations = locationsData["Jamais sans toit"];
        jamaisSansToitLocations.forEach((location) => {
